...
if __name__=='__main__':
    ...
    # model
    parser.add_argument('--num_labels',default=20,type=int)
    parser.add_argument('--batch_size', default=500, type=int)
    parser.add_argument('--val_batch_size',default=1,type=int)
    
    # optimizer
    parser.add_argument('--optimizer',type=str,default='SGD')
    parser.add_argument('--sgd_lr', default=1e-2, type=float)
    ...
    # # restore model
    # # path_checkpoint='./logs/128/model.pth'
    # path_checkpoint='../model_zoo/Mink16UNet34C_ScanNet.pth'
    # checkpoint = torch.load(path_checkpoint)  # checkpoint
    # net.load_state_dict(checkpoint['state_dict'])
        
    # # val_loader 
    # path_val='/net/pf-pc27/scratch3/scannet/dataset/train/*.pth' 
    # val_loader=get_val_loader(path_val,config)
