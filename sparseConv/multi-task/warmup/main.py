...
if __name__=='__main__':
    ...
    parser.add_argument('--val_freq', type=int, default=60)
    ...
    parser.add_argument('--pretrained_weights', type=str, default='../../model_zoo/sem_seg.pth')
    ...
    # test_loader=get_testdataset(path_test,config)
    # test(net,test_loader,device,config)
