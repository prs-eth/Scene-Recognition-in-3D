...
if __name__=='__main__':
    path_train='/net/pf-pc27/scratch3/scannet/train/*/*.pth' 
    path_val='/net/pf-pc27/scratch3/scannet/val/*/*.pth' 
    path_test='/net/pf-pc27/scratch3/scannet/scans_test/*/*.pth'
    ...
    parser.add_argument('--sem_num_labels',default=21,type=int)
    ...
    parser.add_argument('--val_freq', type=int, default=80)
    ...
    # logs
    parser.add_argument('--dump_dir',type=str,default='logs/warmup')
    parser.add_argument('--pretrained_weights', type=str, default='../semseg/logs/semseg/model.pth')
